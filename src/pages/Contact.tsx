...
const Contact: React.FC = () => {
  return <div><div className="text-center bg-gray-200 py-4 mt-10">
  <p className="text-lg italic font-semibold">“There’s no silver bullet with cybersecurity; a layered defense is the only viable option.” — James Scott.</p>
