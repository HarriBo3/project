...
const Home = () => {
  const [sections, setSections] = useState([
    ...
    { id: 3, content: "New content for section 3", imgSrc: "https://via.placeholder.com/100" },
    { id: 4, content: "New content for section 3", imgSrc: "https://via.placeholder.com/100" }
  ]);

  return (
    <div className="flex justify-between items-start w-full">
      <ScrollArea className="rounded-3xl bg-gray-100 flex flex-col items-center justify-center p-5 m-2 w-1/2 h-96">
